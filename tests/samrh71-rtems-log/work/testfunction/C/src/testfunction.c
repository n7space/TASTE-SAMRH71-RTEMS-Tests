...
void testfunction_PI_trigger_check(void)
{
    ...
    if(latest_activation_entry_index == 16 && size_of_activation_log == 17 &&
       ...
       activation_log[0].timestamp > 198000000 && activation_log[0].timestamp < 201000000 &&
       activation_log[1].interface == triggerfunction_trigger && activation_log[1].entry_type == Monitor_EntryType_deactivation &&
       activation_log[1].timestamp > 198000000 && activation_log[1].timestamp < 201000000 && activation_log[1].timestamp > activation_log[0].timestamp &&
       activation_log[2].interface == receiver_sporadic_if && activation_log[2].entry_type == Monitor_EntryType_activation &&
       activation_log[2].timestamp > 198000000 && activation_log[2].timestamp < 201000000 && activation_log[2].timestamp > activation_log[1].timestamp &&
       activation_log[3].interface == receiver_sporadic_if && activation_log[3].entry_type == Monitor_EntryType_deactivation &&
       activation_log[3].timestamp > 198000000 && activation_log[3].timestamp < 201000000 && activation_log[3].timestamp > activation_log[2].timestamp &&
       activation_log[4].interface == receiver_cyclic_if && activation_log[4].entry_type == Monitor_EntryType_activation &&
       activation_log[4].timestamp > 298000000 && activation_log[4].timestamp < 301000000 && activation_log[4].timestamp > activation_log[3].timestamp &&
       activation_log[5].interface == receiver_cyclic_if && activation_log[5].entry_type == Monitor_EntryType_deactivation &&
       activation_log[5].timestamp > 298000000 && activation_log[5].timestamp < 301000000 && activation_log[5].timestamp > activation_log[4].timestamp &&
       activation_log[6].interface == triggerfunction_trigger && activation_log[6].entry_type == Monitor_EntryType_activation &&
       activation_log[6].timestamp > 398000000 && activation_log[6].timestamp < 401000000 &&
       activation_log[16].interface == testfunction_trigger_freeze && activation_log[16].entry_type == Monitor_EntryType_activation &&
       activation_log[16].timestamp > 698000000 && activation_log[16].timestamp < 701000000)
    {
